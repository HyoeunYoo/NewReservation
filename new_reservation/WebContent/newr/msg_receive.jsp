...
<%  
				...
				"select count(*) from msg2 where receiver = ? ");
				...
				pstmt = conn.prepareStatement(
				"select * from msg2 where receiver = ? order by msg_time desc");
				pstmt.setString(1, id);
				rs = pstmt.executeQuery();
%>
				<div class="sendmessege" data-example-id="striped-table">
					<table class="table table-hover" style="table-layout: fixed;">
						<thead>
							...
							<td width=15% class="text-center">보낸 사람</td>
...
%>
						<tbody>
							<tr>
								...
								<td style="text-overflow: ellipsis; overflow: hidden; cursor: pointer;"><nobr><a href="msg_rcontent.jsp?idx=<%=idx%>&answer=<%=sender%>"><%=msg_title%></a></nobr></td>

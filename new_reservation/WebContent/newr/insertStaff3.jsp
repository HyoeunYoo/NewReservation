...
<%@ page import="newr.business.BusinessStaffDBBean3" %>
<%@ page import="newr.business.BusinessStaffDataBean3" %>

<% request.setCharacterEncoding("utf-8");%>

<jsp:useBean id="staff" class="newr.business.BusinessStaffDataBean3">
...
BusinessStaffDBBean3 businessStaff = BusinessStaffDBBean3.getInstance();

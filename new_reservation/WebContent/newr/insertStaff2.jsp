...
<%@ page import="newr.business.BusinessStaffDBBean2" %>
<%@ page import="newr.business.BusinessStaffDataBean2" %>

<% request.setCharacterEncoding("utf-8");%>

<jsp:useBean id="staff" class="newr.business.BusinessStaffDataBean2">
...
BusinessStaffDBBean2 businessStaff = BusinessStaffDBBean2.getInstance();

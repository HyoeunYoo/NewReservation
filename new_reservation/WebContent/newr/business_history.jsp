					...
					if(total1 > 0){
						...
						while(rs3.next()){
							...
							<tr class="business_reserv">
								...
								<td><%=phone%></td>
								<td id="changecancel">
									<a href="#" onclick="cancelFunction(<%=schedule_num%>)" data-toggle="modal" data-target="#cancelModal" title="예약취소">
...
<script>
function cancelFunction(schedule_num) {
    $('input[name=schedule_num]').val(schedule_num);
}
</script>

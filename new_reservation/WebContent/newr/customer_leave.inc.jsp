...
<form action="deleteCustomerPro.jsp" method="post" class="form-horizontal">
	<div class="agreeArea">
		<div class="agree">
				<h6 align="left">
				<strong>NEWR 회원 탈퇴가 완료되면 회원님의 개인정보는 즉시 삭제됩니다.</strong><br><br>
				회원 탈퇴 처리 후에는 회원님의 개인정보를 복원할 수 없으며,<br><br>
				재 가입은 탈퇴일로부터 24시간 후에 가능하고 탈퇴한 id는 재사용이 불가합니다.<br><br>
				<strong>회원 탈퇴 신청 전에 아래 사항을 반드시 확인해 주시기 바랍니다.</strong><br><br>
	...
	<div class="container" id="custom_leave_form">
		<div class="container custom_leave_align">
			<input type="password" placeholder="비밀번호를 입력해주세요." class="form-control c_pwd_input" id="inform_200" name="passwd">
			<input type="submit" class="btn btn-default c_pwd_btn" value="탈퇴하기">
		</div>
	</div>

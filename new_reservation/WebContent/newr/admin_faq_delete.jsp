...
<div class="main">
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<form class="form-horizontal" method="post" action="admin_faq_deletePro.jsp">
				...
				<div class="form-group">
					...
					<div class="col-sm-11">
						<textarea class="form-control" name="content" rows="10" readonly="readonly"><%=content%></textarea>
					</div>
				</div>

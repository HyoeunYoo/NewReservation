	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="row" id="join">
				<div class="container nailcontainer col-md-4">
					<ul>
						<a href="business_nail_enroll.jsp">
							<div class="container surgery_info" id="inform">
								<p class="sg_select">NAIL</p><br>
								<p class="sg_detail">직원등록</p>
							</div>
						</a>
					</ul>
				</div>
				<div class="container eyelashcontainer col-md-4" >
					<ul>
						<a href="business_eyelash_enroll.jsp">
							<div class="container surgery_info" id="inform">
								<p class="sg_select">EYELASH</p><br>
								<p class="sg_detail">직원등록</p>
							</div>
						</a>
					</ul>
				...
				<div class="container waxingcontainer col-md-4" >
					<ul>
						<a href="business_waxing_enroll.jsp">
							<div class="container surgery_info" id="inform">
								<p class="sg_select">WAXING</p><br>
								<p class="sg_detail">직원등록</p>
							</div>
						</a>
					</ul>

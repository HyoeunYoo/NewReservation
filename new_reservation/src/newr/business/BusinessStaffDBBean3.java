...
public class BusinessStaffDBBean3 {

	private static BusinessStaffDBBean3 instance = new BusinessStaffDBBean3();

	public static BusinessStaffDBBean3 getInstance() {
		return instance;
	}

	private BusinessStaffDBBean3(){}
	...
	public void insertStaff(BusinessStaffDataBean3 staff, String id) throws Exception {

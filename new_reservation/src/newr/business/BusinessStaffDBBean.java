...
public class BusinessStaffDBBean {

	private static BusinessStaffDBBean instance = new BusinessStaffDBBean();

	public static BusinessStaffDBBean getInstance() {
		return instance;
	}

	private BusinessStaffDBBean(){}
	...
	public void insertStaff(BusinessStaffDataBean staff, String id) throws Exception {
